...
namespace MasterDetailsRelationships
{
    public partial class ThisWorkbook
    {
        ...
        /// <summary>
        /// Метод доступа CurrentCompanyData; обеспечивает загрузку данных для образца, и возвращает эти данные 
        /// через объект CompanyData
        /// </summary>
        ...
        /// <summary>
        /// Обеспечивает считывание данных из источника данных, чтобы образец выполнялся должным образом.
        /// </summary>
